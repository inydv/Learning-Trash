...
import { GET_USER_DETAILS, UPDATE_USER, RESET_UPDATE_USER } from "../../../redux/user/userApiCall";
...
export default function UpdateUser() {
  ...
  useEffect(() => {
    ...
    if (updateUser) {
      dispatch(RESET_UPDATE_USER());
      navigate("/admin/users");
    }
  }, [dispatch, error, updateUser, user, userId, navigate]);
